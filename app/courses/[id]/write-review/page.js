    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f3f4f5] p-8">
        <div className="bg-white rounded-2xl p-12 text-center shadow-sm">
          <h1 className="text-xl font-bold mb-4">ไม่พบวิชา</h1>
          <Link href="/courses" className="text-[#006b2c] hover:underline text-sm">กลับหน้ารายวิชา</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-[#f3f4f5]">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-10">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#6e7b6c] mb-6 flex-wrap">
          ...
          <Link href={`/courses/${id}`} className="hover:text-[#006b2c] transition-colors">{course.code}</Link>
          <span className="material-symbols-outlined text-xs">chevron_right</span>
          <span className="font-semibold text-[#006b2c]">เขียนรีวิว</span>
        </nav>
        ...
        <header className="mb-8 md:text-left">
          <h1 className="text-3xl md:text-4xl font-extrabold text-[#191c1d]" style={{ fontFamily: 'Manrope, Sarabun, sans-serif' }}>
            เขียนรีวิว: <span className="text-[#006b2c]">{course.code}</span>
          </h1>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h2 className="font-bold text-[#191c1d] mb-1">คุณรีวิววิชานี้ไปแล้ว</h2>
                  <p className="text-sm text-slate-500 mb-3">
                    เทอม {existing.semester} · เกรด {existing.gradeReceived}
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <DeleteReviewButton courseCode={course.code} courseId={id} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#baecbc]/30 p-6 rounded-xl">
                <h3 className="font-bold mb-3 flex items-center gap-2 text-[#3b6842]">
                  <span className="material-symbols-outlined">lightbulb</span> เคล็ดลับการเขียน
                </h3>
                <ul className="text-sm space-y-2 text-[#406c46] list-disc list-inside">
                  <li>ระบุชื่ออาจารย์ผู้สอน (ถ้าจำได้)</li>
                  <li>สไตล์การสอน (Slide / บรรยาย / Workshop)</li>
                  <li>ข้อสอบเน้นส่วนไหนเป็นพิเศษ</li>
                  <li>คำแนะนำสำหรับรุ่นน้องที่จะลงวิชานี้</li>
                </ul>
              </div>
              <div className="bg-[#ffd9de]/20 p-6 rounded-xl">
                <h3 className="font-bold mb-3 flex items-center gap-2 text-[#a72d51]">
                  <span className="material-symbols-outlined">gavel</span> ข้อควรระวัง
                </h3>
                <p className="text-sm text-[#3e4a3d] leading-relaxed">
                  กรุณาใช้คำสุภาพและไม่ระบุข้อมูลส่วนตัวที่อาจส่งผลกระทบต่อผู้อื่น
                  รีวิวทั้งหมดจะถูกตรวจสอบโดยระบบเบื้องต้น
                </p>
              </div>
            </div>
          </>
